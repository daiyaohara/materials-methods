...
def change_special(str):
    ...
    try:
        ...
        pass
    return str2
def makestr(list_a,A,B,C,D,E,F,G,H,I,J,b,l,row_list):
    tag = list_a[1]
    No = int(list_a[0])
...
<table>
<tr>"""
                for y in range(1,len(row_list[i])):
                    if row_list[i+2][y] == '':
                        break
                    else:
                        str5 = """<th>{0}</th>""".format(row_list[i+2][y])
                        str1 = str1 + str5
                str1 = str1 + """</tr>"""
...
<tr>"""
                for y in range(1,len(row_list[i])):
                    if row_list[i+2][y] == '':
                        ...
                        str5 = """<td>{0}</td>""".format(row_list[i+2][y])
                        str1 = str1 + str5
                str1 = str1 + '</tr>'
...
for l in range(num):#range(num)
    ...
    for row in range(0, sheet.nrows):
        ...
        for col in range(0, sheet.ncols):
            row_list[row].append(sheet.cell(row,col).value)
   ...
   #txt fileへの出力
    str = makestr(list_a,list_A,list_B,list_C,list_D,list_E,list_F,list_G,list_H,list_I,list_J,b,l,row_list=row_list)
